...
if(isset($_POST['submit']))
{
  ...
  else 
  {
    ...
    $sql="UPDATE agent_table SET password='$password' WHERE AgentID='$AgentID'";

    if (mysqli_query($conn, $sql))
    {
     
    echo "<script> alert('Password Changed');window.location.href = 'manage_agents.php'</script>";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="Confirm-password" type="password" class="form-control col-md-7 col-xs-12" name="confirm_password" placeholder="Confirm Password" required="required">
                        </div>
                      </div>
