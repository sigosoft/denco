...
$query="SELECT * FROM payment_collection";
$result=mysqli_query($conn,$query);


$Total_query=mysqli_query($conn,"SELECT (SELECT SUM(Amount) FROM payment_collection) AS Total");
...
$Grand=$total_row['Total'];
 ...
 $sql="SELECT * FROM payment_collection WHERE (PaymentDate >= '$from' AND PaymentDate <= '$to')";

 $result=mysqli_query($conn,$sql);
 
 
$Total_query=mysqli_query($conn,"SELECT (SELECT SUM(Amount) FROM payment_collection WHERE (PaymentDate >= '$from' AND PaymentDate <= '$to')) AS Total");
...
if(isset($_POST['submit1']))
 ...
 $sql="SELECT * FROM payment_collection WHERE (PaymentDate >= '$from' AND PaymentDate <= '$to' AND AgentID='$AgentID')";

 $result=mysqli_query($conn,$sql);
 
 
$Total_query=mysqli_query($conn,"SELECT (SELECT SUM(Amount) FROM payment_collection WHERE (PaymentDate >= '$from' AND PaymentDate <= '$to' AND AgentID='$AgentID')) AS Total");
...
<div class="right_col" role="main">
 ...
 <div class="clearfix"></div>
       ...
       echo date("jS F, Y", strtotime("$PaymentDate")); ?></td>
                       
                            <td><?php $o_time =  $row['PaymentTime'];
