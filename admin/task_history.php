...
$task_list="SELECT agent_tasks.*, clinics.* FROM agent_tasks INNER JOIN clinics ON agent_tasks.ClinicID=clinics.ClinicID AND agent_tasks.Flag='1' AND TaskStartDate > $current_date AND agent_tasks.TaskType='Temporary'";
$result_task_list=mysqli_query($conn,$task_list);


$started="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Started'";
$result_started=mysqli_query($conn,$started);

$completed="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Completed'";
...
$task_list="SELECT agent_tasks.*, clinics.* FROM agent_tasks INNER JOIN clinics ON agent_tasks.ClinicID=clinics.ClinicID AND agent_tasks.Flag='1' AND TaskStartDate > $current_date AND agent_tasks.ClinicID='$clinicIDE' AND agent_tasks.TaskType='Temporary'";
$result_task_list=mysqli_query($conn,$task_list);




$started="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Started' AND agent_live_task.ClinicID='$clinicIDE'";
$result_started=mysqli_query($conn,$started);

$completed="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Completed' AND agent_live_task.ClinicID='$clinicIDE'";
...
$task_list="SELECT agent_tasks.*, clinics.* FROM agent_tasks INNER JOIN clinics ON agent_tasks.ClinicID=clinics.ClinicID AND agent_tasks.Flag='1' AND TaskStartDate > $current_date AND agent_tasks.AgentID='$AgentIDE' AND agent_tasks.TaskType='Temporary'";
$result_task_list=mysqli_query($conn,$task_list);




$started="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Started' AND agent_live_task.AgentID='$AgentIDE'";
$result_started=mysqli_query($conn,$started);

$completed="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Completed' AND agent_live_task.AgentID='$AgentIDE'";
      ...
      echo date('h:i a' , strtotime($Start)); ?></li><br><br>
       ...
       echo date("jS F, Y", strtotime("$CTaskEndDate")); ?></li>
                                       ...
                                       ?>
                                        ...
                                        <li class="pull-left"><?php $End =  $row_com['EndTime'];
