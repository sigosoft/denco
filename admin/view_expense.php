...
$Grand=$tot;
 ...
 $sql="SELECT * FROM expense_table WHERE (expense_date >= '$from' AND expense_date <= '$to' AND AgentID='$AgentID')";

 $result=mysqli_query($conn,$sql);
 
 
$Total_query=mysqli_query($conn,"SELECT (SELECT SUM(Amount) FROM expense_table WHERE (expense_date >= '$from' AND expense_date <= '$to' AND AgentID='$AgentID')) AS Total");
