                    ...
                    <div class="img_section">
                        <div class="icon_wrapper_event">
                         ...
                         <div class="img_wrapper2">
							<img src="images/p1.png" alt="img" class="img-responsive">
                         </div>
                         <div class="event_icon1 event_icon3">
                            <h2><a href="#">Metal Free Ceramic (All Ceramics)</a></h2>
                            <p>(I)) (D) Zirconium (Supreme) 3 Working Days<br>
(II) (D) Zirconium (Premium) 3 Working Days<br>
(III) (D) Zirconium (Regular) 3 Working Days<br>
(IV) (D) Zirconium (Monolithic) 3 Working Days</p>
                        </div>
            		</div>
                </div>
				<div class="col-lg-12">
                    <div class="img_section">
                        <div class="icon_wrapper_event">
                         ...
                         <div class="img_wrapper2">
							<img src="images/p2.png" alt="img" class="img-responsive">
                         </div>
                         <div class="event_icon1 event_icon3">
                            <h2><a href="#">Metal Ceramic (PFM)</a></h2>
                             <p>(I) CADCAM (D) PFM 3 Working Days<br>
(II) MLS (6 Working Days) (Laser Sintered) PFM<br>
(III) (D) PFM (Supreme) 2 Working Days (Premium) 2 Working Days (Regular) 2 Working Days<br>
(IV)  CF (Metal Ceramic Facing)  2 Working Days
                                             (Supreme), 
                                             (Premium), 
                                             (Regular)<br>
(V)   FM  (Full Metal)</p>
				...
				<div class="col-lg-12">
                    <div class="img_section">
                        <div class="icon_wrapper_event">
                         ...
                         <div class="img_wrapper2">
							<img src="images/p3.png" alt="img" class="img-responsive">
                         </div>
                         <div class="event_icon1 event_icon3">
                            <h2><a href="#">Implants</a></h2>
