...
$task_list="SELECT agent_tasks.*, clinics.* FROM agent_tasks INNER JOIN clinics ON agent_tasks.ClinicID=clinics.ClinicID AND agent_tasks.Flag='1' AND TaskStartDate >= $from AND TaskStartDate >= $to AND agent_tasks.AgentID='$AgentIDE' AND agent_tasks.TaskType='Temporary' order by TaskID desc";
$result_task_list=mysqli_query($conn,$task_list);




$started="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Started' AND agent_live_task.AgentID='$AgentIDE' AND StartDate>='$from' AND StartDate<='$to' order by AgentLiveTaskID desc";
$result_started=mysqli_query($conn,$started);

$completed="SELECT agent_live_task.*, clinics.* FROM agent_live_task INNER JOIN clinics ON agent_live_task.ClinicID=clinics.ClinicID WHERE agent_live_task.Status='Completed' AND agent_live_task.AgentID='$AgentIDE' AND StartDate>='$from' AND StartDate<='$to' order by AgentLiveTaskID desc";
