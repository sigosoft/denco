...
$sql="INSERT INTO expense_category(expesne_category_name,StatusExp) VALUES ('$CategoryName','Active')";

if (mysqli_query($conn, $sql))
 {
    echo "<script> alert('Expense Category Added Successfully');window.location.href = 'manage_exp_category.php';</script>";
 } 

else 
{

    echo "<script> alert('Upload Error');window.location.href = 'create_category.php';</script>";
}
};
