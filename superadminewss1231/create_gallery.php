...
if(isset($_POST['submit']))
{
    ...
    $target_dir = "../uploads/gallery/"; //directory details
    ...
    $update="INSERT INTO gallery(Image) VALUES('$image')";
   

     if (mysqli_query($conn, $update))
    {
     
    echo "<script> alert('Image Addded Successfully');window.location.href = 'gallery_images.php';</script>";
...
else
{
   ...
   echo "<script> alert('Upload Error');window.location.href = 'create_gallery.php';</script>";
}
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Upload Image <span class="required">(550*360) *</span>
                        </label>
