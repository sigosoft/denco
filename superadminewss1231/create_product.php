...
$sql="INSERT INTO products(CategoryID, SubcategoryID, ProductName, ProductMRP) VALUES ('$CategoryID ', '$SubcategoryID', '$ProductName',' $ProductMRP')";

if (mysqli_query($conn, $sql))
 {
    echo "<script> alert('Products Added Successfully');window.location.href = 'manage_product.php';</script>";
 } 
...
<select name="SubcategoryID" id="SubcategoryID" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="ProductMRP" type="number" class="form-control col-md-7 col-xs-12" name="ProductMRP" placeholder="Product MRP" required="required" type="text">
                        </div>
                      </div>
