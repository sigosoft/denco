...
if(isset($_POST['submit']))
{
    ...
    $update="UPDATE agent_table SET Image='$image' WHERE AgentID='$AgentID'";
    ...
    header("location:edit_agents.php?id=$AgentID");
    ...
    echo "<script> alert('Upload Error');window.location.href = 'manage_agents.php';</script>";
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="submit" class="btn btn-primary" onClick="document.location.href='splash.php'">Cancel</button>
