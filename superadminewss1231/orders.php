...
$Grand=$tot;
 ...
 if(isset($_POST['submit1']))
 {
    ...
    $sql1="SELECT * FROM orders WHERE AgentID='$agent' AND OrderDate >= '$from' AND OrderDate <= '$to'";
    $result=mysqli_query($conn,$sql1);
   
   $Total_query1=mysqli_query($conn,"select SUM(GrandTotal) as Total FROM orders WHERE AgentID='$agent' AND OrderDate >= '$from' AND OrderDate <= '$to'");
