...
if(isset($_POST['submit1']))
 ...
 $sql1="SELECT * FROM payment_collection WHERE AgentID='$agent' AND PaymentDate >= '$from' AND PaymentDate <= '$to'";
 $result=mysqli_query($conn,$sql1);


    $Total_query1=mysqli_query($conn,"SELECT SUM(Amount) AS Total FROM payment_collection WHERE AgentID='$agent' AND PaymentDate >= '$from' AND PaymentDate <= '$to'");
